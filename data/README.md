...
The `fire_hazard_data_mode = "cached"` setting reuses validated local fire-hazard source data and derived products.
...
| Critical infrastructure | Hospitals, fire stations, law enforcement facilities, schools, and emergency shelters | Utah GIS |
...
All source datasets remain subject to the licenses, terms, attribution requirements, and usage policies of their respective publishers. The project license applies only to the original code and documentation in this repository and does not relicense external data.
